<template>
  <div class="goods">
    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <!--eslint-disable-next-line-->
        <li v-for="(item,index) in goods" class="goods-list" ref="foodListHook">
    ...
    <shopcart ref="shopcart" :select-foods="selectFoods" :delivery-price="seller.deliveryPrice"
              :min-price="seller.minPrice" v-on:shopcart-add="cartAdd"></shopcart>
...
//      sessionStorage.setItem('selectFoods', foods)
  ...
  methods: {
    selectMenu (index, event) {
      ...
      this.foodsScroll.scrollToElement(le, 200)
